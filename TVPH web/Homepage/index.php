...
<head>
  ...
  <title>Trending Visuals PH</title>
        ...
        <form action="#">
          ...
          <div class="newsletter-header">
            ...
            <p class="newsletter-desc">
              Subscribe to <b>Us</b> and get latest products and discount update.
            </p>
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <div class="header-search-container">
          ...
          <input id="txt" type="search" name="search" class="search-field" placeholder="Enter your product name...">
    ...
    <nav class="desktop-navigation-menu">
      ...
      <div class="container">
        ...
        <ul class="desktop-menu-category-list">
          ...
          <li class="menu-category">
            <a href="#" class="menu-title">Penthouse</a>
          ...
          <li class="menu-category">
            <a href="#" class="menu-title">Hometown<br>ChaChaCha</a>

            <ul class="dropdown-list">

              <li class="dropdown-item">
                <a href="#">Chief Hong's ID holder</a>
              </li>

              <li class="dropdown-item">
                <a href="#">Hye Jin's Ring</a>
              </li>
          ...
          <li class="menu-category">
            <a href="#" class="menu-title">My Demon</a>

            <ul class="dropdown-list">

              <li class="dropdown-item">
                <a href="#">My Demon Rings</a>
              </li>

              <li class="dropdown-item">
                <a href="#">My Demon Tattoo</a>
              </li>
          ...
          <li class="menu-category">
            <a href="#" class="menu-title">True Beauty</a>
          ...
          <li class="menu-category">
            <a href="#" class="menu-title">Extraordinary<br> Atty Woo</a>
           ...
           <li class="menu-category">
            <a href="#" class="menu-title">Alchemy of Souls <br> Y&Y Jade Eggs</a>
      ...
      <div class="container">
        ...
        <div class="slider-container has-scrollbar">
          ...
          <div class="slider-item">
            ...
            <img src="./img/Penthouse/School ID/p1.webp" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Trending Visuals PH</p>

              <h2 class="banner-title">Penthouse Photocards</h2>
          ...
          <div class="slider-item">
            ...
            <img src="./img/My Demon/My Demon Rings/p1.jpg.webp" class="banner-img" background-size=" cover" object-fit="cover">

            <div class="banner-content">

              <p class="banner-subtitle">Trending Visuals PH</p>

              <h2 class="banner-title">My Demon Rings</h2>
          ...
          <div class="slider-item">
            ...
            <img src="./img/Penthouse/School ID/" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Trending Visuals PH</p>

              <h2 class="banner-title">Alchemy of Souls Amulet</h2>
            ...
            <ul class="sidebar-menu-category-list">
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <p class="menu-title">Penthouse</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">School ID</p>
                      <data value="300" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <p class="menu-title">HometownChaChaCha</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">Chief Hong's ID holder</p>
                      <data value="45" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>

                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">Hye Jin's Ring</p>
                      <data value="75" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
              ...
              <li class="sidebar-menu-category">
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">My Demon Rings</p>
                      <data value="46" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>

                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name"> My Demon Tattoo</p>
                      <data value="73" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <p class="menu-title">True Beauty</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">School ID</p>
                      <data value="12" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>

                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">Skeleton Stickers</p>
                      <data value="60" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <p class="menu-title">Extraordinary ATTY. Woo</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">School ID</p>
                      <data value="68" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    ...
                    <p class="menu-title">Alchemy of Souls Y&Y <br> Jade Eggs</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">Amulets</p>
                      <data value="50" class="stock" title="Available Stock">₱300.00</data>
                    </a>
                  </li>
                ...
                <div class="showcase-container">
                  ...
                  <div class="showcase">
                    ...
                    <div class="showcase-content">
                      ...
                      <a href="#" class="showcase-category">Photocard</a>
              ...
              <div class="showcase-container">
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-banner">
                    <img src="" alt="insert img" class="showcase-img">
                  </div>
                  ...
                  <div class="showcase-content">
                    ...
                    <a href="#">
                      <h3 class="showcase-title">insert img</h3>
                    </a>
                  ...
                  <div class="showcase-content">
                    ...
                    <div class="countdown-box">
                     ...
                     <!--  <div class="countdown">
                        ...
                        <div class="oras">
            <div class="sub_timer">
                <h1 id="araw" class="digit">00</h1>
                <p class="digit_name">Days</p>
            </div>
            <div class="sub_timer">
                <h1 id="hours" class="digit">00</h1>
                <p class="digit_name">Hours</p>
            </div>
            <div class="sub_timer">
                <h1 id="minuto" class="digit">00</h1>
                <p class="digit_name">Minutes</p>
            </div>
            <div class="sub_timer">
                <h1 id="segundo" class="digit">00</h1>
                <p class="digit_name">Seconds</p>
            </div>
          </div>
                      </div>
            ...
            <div class="service-container">
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <h3 class="service-title">Only in Philippines</h3>
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc"> Orders Only</p>
        ...
        <div class="blog-container has-scrollbar">
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <p class="blog-meta">
                By <cite>Mr Sean</cite> / <time datetime="2022-04-06">Apr 06, 2022</time>
              </p>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <p class="blog-meta">
                By <cite>Mr charles</cite> / <time datetime="2022-01-18">Jan 18, 2022</time>
              </p>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <p class="blog-meta">
                By <cite>Mrs ricci</cite> / <time datetime="2022-02-10">Feb 10, 2022</time>
              </p>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <p class="blog-meta">
                By <cite>Mr em</cite> / <time datetime="2022-03-15">Mar 15, 2022</time>
              </p>
  ...
  <footer>
    ...
    <div class="footer-category">
      ...
      <div class="container">
        ...
        <div class="footer-category-box">
          <h3 class="category-box-title">Photocard :</h3>
    ...
    <div class="footer-nav">
      ...
      <div class="container">
        ...
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item">
            <a href="#" class="footer-nav-link">Photocard</a>
          </li>
        ...
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item flex">
            ...
            <a href="tel:+607936-8058" class="footer-nav-link">0909 090 9090</a>
          </li>
          ...
          <li class="footer-nav-item flex">
            ...
            <a href="mailto:example@gmail.com" class="footer-nav-link">kkopal@gmail.com</a>
          </li>
    ...
    <div class="footer-bottom">
      ...
      <div class="container">
        ...
        <p class="copyright" id="parag">
          &copy;all rights reserved.  <br>  <a href="#">Trending Visuals Ph</a> 
        </p>
